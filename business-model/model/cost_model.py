...
Run from any directory with: python3 business-model/model/cost_model.py
Standard library only. Writes business-model/model/unit-economics.json and prints
the tables used in business-model/README.md.
