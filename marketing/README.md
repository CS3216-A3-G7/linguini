...
| [`analytics/`](analytics/milestone-analytics.html) | Analytics milestone write-up: Contentsquare set-up and checks, the Home redesign before and after, journeys from Home, mobile against desktop, data caveats and next metrics. Yellow boxes mark screenshots and claims to add or confirm before pasting into the Google Doc |
