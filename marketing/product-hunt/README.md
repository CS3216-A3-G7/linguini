...
| [Launch campaign blog post](../../landing/components/blog/posts/LaunchCampaign.tsx) | Public write-up at `/blog/launch-week`: the reasoning, animated mockups of every post, banners, runbook, retention plan and a tickable checklist ([`Checklist.tsx`](../../landing/components/blog/launch/Checklist.tsx), post text in [`content.ts`](../../landing/components/blog/launch/content.ts)). Keep it in step with [plan.md](plan.md) and [social-posts.md](social-posts.md). |
