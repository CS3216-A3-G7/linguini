...
| 4 | **Most landing-page photo licences are unconfirmed.** All 11 demo photos come from MIT-licensed theme repositories, but the MIT licence covers the code, not necessarily the photos. Our own credits file records "original photo licence not stated" or "likely Unsplash" for 9 of them, and "verify before launch" for the 2 picjumbo photos. These photos appear in the hero, the demo, the OG images and probably the gallery. | `landing/public/photos/credits.json` | **Blocker** for the gallery and video. **High risk** for the landing page |
